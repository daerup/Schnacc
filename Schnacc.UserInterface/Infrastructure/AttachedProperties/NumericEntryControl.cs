...
namespace Schnacc.UserInterface.Infrastructure.AttachedProperties
{
    public class TextBoxHelpers : UserControl
    {
        ...
        public static void SetIsNumeric(DependencyObject obj, bool value) => obj.SetValue(TextBoxHelpers.IsNumericProperty, value);
        ...
        private static void TargetTextBoxPreviewKeyDown(object sender, KeyEventArgs e) => e.Handled = e.Key == Key.Space;
